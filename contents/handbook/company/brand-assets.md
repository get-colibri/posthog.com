...
| Name                                  | Weight   | Size | Letter spacing | Line height | Name                                  | Weight   | Size | Letter spacing | Line height |
|---------------------------------------|----------|------|----------------|-------------|---------------------------------------|----------|------|----------------|-------------|
| h1                                    | Bold     | 64px | -1%            | 100%        | h1                                    | Bold     | 64px | -1%            | 100%        |
| h2                                    | Bold     | 48px | -1%            | 120%        | h2                                    | Bold     | 48px | -1%            | 120%        |
| h3                                    | Bold     | 30px | -2%            | 140%        | h3                                    | Bold     | 30px | -2%            | 140%        |
| h4                                    | Bold     | 24px | -2%            |             | h4                                    | Bold     | 24px | -2%            |             |
| h5                                    | Semibold | 20px | -2%            |             | h5                                    | Semibold | 20px | -2%            |             |
| h6                                    | Semibold | 16px | 0              |             | h6                                    | Semibold | 16px | 0              |             |
| Paragraphs accompanying large headers | Semibold | 20px | -1%            | 125%        | Paragraphs accompanying large headers | Semibold | 20px | -1%            | 125%        |
| p                                     | Regular  | 17px |                | 175%        | p                                     | Regular  | 17px |                | 175%        |
| p (small)                             | Regular  | 15px |                | 150%        | p (small)                             | Regular  | 15px |                | 150%        |
